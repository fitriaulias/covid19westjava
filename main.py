...
def tampilkan_data(result):
    ...
    print(f"Terkonfirmasi {result['terkonfirmasi']}")
    ...
    print(f"Kontak Erat {result['kontak_erat']}")
    print(f"Dikarantina {result['dikarantina']}")
    print(f"Discarded Kontak Erat {result['discarded_kontak']}")
    print(f"Suspek {result['suspek']}")
    print(f"Isolasi Suspek {result['isolasi_suspek']}")
    print(f"Discarded Suspek {result['discarded_suspek']}")
    print(f"Total Probable {result['total_probable']}")
    print(f"Isolasi Probable {result['isolasi_probable']}")
    print(f"Sembuh Probable {result['sembuh_probable']}")
    print(f"Meninggal Probable {result['meninggal_probable']}")
    pass
